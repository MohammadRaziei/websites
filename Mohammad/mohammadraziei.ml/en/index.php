    ...
    <div class="intro">
        ...
        <div class="social-icons">
            <ul class="list-inline">
                ...
                <li><a target=_blank href="mailto:mohammadraziei1375@gmail.com?&subject=Contact%20Us&body=Sent%20from%20https://mohammadraziei.ml/en"><i class="fa fa-envelope" aria-hidden="true"></i></a></li>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="custom-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="../fa"><img class="flags" src='../assets/images/flags/uk-flag-small.png' onmouseover="this.src='../assets/images/flags/iran-flag-small.png';" onmouseout="this.src='../assets/images/flags/uk-flag-small.png';" /></a></li>
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-md-push-8">
                <div class="biography">
                    ...
                    <ul>
                        <li><strong>Name:</strong> MOhammad Raziei</li>
            ...
            <div class="col-md-8 col-md-pull-4">
                ...
                <div class="my-signature">
                    <img style="width : 170px; height: 110px;" src="/common/images/sign.png" alt="my sign">
                </div>

                <div class="download-button">
                    <a class="btn btn-info btn-lg" href="#contact"><i class="fa fa-paper-plane"></i>Send me message</a>
                    <a class="btn btn-primary btn-lg" href="../resume/en"><i class="fa fa-download"></i>download my cv</a>
                </div>
            </div>
